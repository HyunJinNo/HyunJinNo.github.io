...
<img src="/assets/img/front-end/react-native-basic/pic2.avif" alt="pic2" />
...
<img src="/assets/img/front-end/react-native-basic/pic3.avif" alt="pic3" />

<br/>

다운로드한 파일을 다음과 같이 압축 해제합니다.

<img src="/assets/img/front-end/react-native-basic/pic4.avif" alt="pic4" />

<br/>

이후 `시스템 환경 변수 편집 > 환경 변수`으로 이동한 후 다음과 같이 변수 이름에 `JAVA_HOME`을, 변수 값에 방금 설치한 `openJDK 17`의 경로를 지정하여 새로운 시스템 변수를 생성합니다.

<img src="/assets/img/front-end/react-native-basic/pic5.avif" alt="pic5" />

<br/>

이후 시스템 변수 path의 편집 버튼을 누른 뒤 다음과 같이 `%JAVA_HOME%\bin`을 추가합니다.

<img src="/assets/img/front-end/react-native-basic/pic6.avif" alt="pic6" />
...
<img src="/assets/img/front-end/react-native-basic/pic8.avif" alt="pic8" />
...
<img src="/assets/img/front-end/react-native-basic/pic9.avif" alt="pic9" />

<br/>

이후 `시스템 환경 변수 편집 > 환경 변수`으로 이동한 후 다음과 같이 변수 이름에 `ANDROID_HOME`을, 변수 값에 방금 설치한 `Android SDK`의 경로를 지정하여 새로운 사용자 변수를 생성합니다.

<img src="/assets/img/front-end/react-native-basic/pic10.avif" alt="pic10" />

<br/>

이후 사용자 변수 path의 편집 버튼을 누른 뒤 다음과 같이 `platform-tools` 경로를 추가합니다.

<img src="/assets/img/front-end/react-native-basic/pic11.avif" alt="pic11" />
...
<img src="/assets/img/front-end/react-native-basic/pic12.avif" alt="pic12" />
...
<img src="/assets/img/front-end/react-native-basic/pic14.avif" alt="pic14" />
...
<img src="/assets/img/front-end/react-native-basic/pic15.avif" alt="pic15" />
...
<img src="/assets/img/front-end/react-native-basic/pic16.avif" alt="pic16" />
