...
description: Next.js MDX 블로그 프로젝트에서 Module not found 오류를 해결한 과정에 대해 기록한 페이지입니다.
...
Troubleshooting, Typescript, Next.js, FSD</p></blockquote>
...
![기존 폴더 구조](/images/front-end/troubleshooting-nextjs-module-not-found/pic2.avif)
...
![변경 이후 폴더 구조](/images/front-end/troubleshooting-nextjs-module-not-found/pic3.avif)

![문제 해결 결과](/images/front-end/troubleshooting-nextjs-module-not-found/pic4.avif)
