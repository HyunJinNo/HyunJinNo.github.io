...
```
<img src="/assets/img/raspberry-pi/nginx1.png" alt="nginx1" />
...
nginx -v
```
<img src="/assets/img/raspberry-pi/nginx2.png" alt="nginx2" />
...
ls -l
```
<img src="/assets/img/raspberry-pi/nginx3.png" alt="nginx3" />    
...
<img src="/assets/img/raspberry-pi/nginx4.png" alt="nginx4" />    
...
```
<img src="/assets/img/raspberry-pi/nginx5.png" alt="nginx5" />    
...
<img src="/assets/img/raspberry-pi/nginx6.png" alt="nginx6" />  
...
sudo nginx -t
```
<img src="/assets/img/raspberry-pi/nginx7.png" alt="nginx7" />     
...
``` 
<img src="/assets/img/raspberry-pi/nginx8.png" alt="nginx8" />     
...
pm2 start npm -- start
```
<img src="/assets/img/raspberry-pi/nginx9.png" alt="nginx9" />     

서비스가 실행되면 웹 사이트에 접속합니다.    
<img src="/assets/img/raspberry-pi/nginx10.png" alt="nginx10" />  
