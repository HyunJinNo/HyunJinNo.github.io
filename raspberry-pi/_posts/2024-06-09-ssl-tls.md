...
<img src="/assets/img/raspberry-pi/ssl1.png" alt="ssl1" />    
로그인 이후 도메인 검색 창에서 원하는 도메인 이름을 검색한 후 `등록하기` 버튼을 클릭합니다.

#### Domain 적용
<img src="/assets/img/raspberry-pi/ssl2.png" alt="ssl2" />   
...
<img src="/assets/img/raspberry-pi/ssl3.png" alt="ssl3" />     
...
<img src="/assets/img/raspberry-pi/ssl4.png" alt="ssl4" />     
...
```
<img src="/assets/img/raspberry-pi/ssl5.png" alt="ssl5" />     
지금까지 잘 설치됐는지 확인하기 위해 다음 명령어를 순서대로 입력합니다.   
```bash
sudo snap install hello-world
hello-world
```
<img src="/assets/img/raspberry-pi/ssl6.png" alt="ssl6" />    
`snapd` 설치가 완료되었습니다.
...
```
<img src="/assets/img/raspberry-pi/ssl7.png" alt="ssl7" />    
...
certbot --version
```
<img src="/assets/img/raspberry-pi/ssl8.png" alt="ssl8" />    
...
```
<img src="/assets/img/raspberry-pi/ssl9.png" alt="ssl9" />    
...
```
<img src="/assets/img/raspberry-pi/ssl10.png" alt="ssl10" />    
...
<img src="/assets/img/raspberry-pi/ssl11.png" alt="ssl11" />   
